<template id="profile">
    <v-container grid-list-md fluid>
        <h1>Bio</h1>
        <p>
            Veronique Savard is a language enthusiast who naturally turned to programming. She is convinced that coding goes well beyond computers and can impact humans’ lives positively.
